...
import TwitterProvider, {providerId as TwitterProviderId} from './content-provider/twitter-content-provider';
    ...
    providersOptions.forEach(options => {
      switch (options.contentProvider) {
        ...
        case BingProviderId:
          ...
          break;
        case TwitterProviderId:
          this.providers.push(new TwitterProvider(options));
          break;
        default:
